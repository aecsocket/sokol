...
public final class SoundsStat extends BasicStat<Descriptor<List<PreciseSound>>> {
    ...
    public SoundsStat(List<PreciseSound> defaultValue) {
        super(new TypeToken<Descriptor<List<PreciseSound>>>() {}, new Descriptor<>(defaultValue), (a, b) -> a.operate(OPERATIONS, DEFAULT_OPERATOR, b), v -> v.copy(ArrayList::new));
    }
