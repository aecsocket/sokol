 ...
 */
public abstract class NodeHolderFeature<N extends TreeNode> extends AbstractFeature {
    /** The system ID. */
    ...
    public NodeHolderFeature(int listenerPriority, int capacity, boolean sizeAsDurability, @Nullable Rule rule) {
    ...
    /**
     * See {@link NodeHolderFeature}.
     */
    public abstract class Instance extends AbstractFeature.Instance implements NodeProviderSystem {
        ...
        @Override public abstract NodeHolderFeature<N> base();
