...
/**
 * A base value of a {@link com.gitlab.aecsocket.sokol.core.util.TreeNode}, storing the slots and base systems.
 */
public interface Component extends Keyed {
     ...
     */
    Map<String, ? extends Feature> baseSystems();
     ...
     * @return An Optional of the result.
     */
    Optional<? extends Feature> baseSystem(String id);
     ...
     */
    interface Scoped<C extends Scoped<C, S, B>, S extends Slot, B extends Feature> extends Component {
