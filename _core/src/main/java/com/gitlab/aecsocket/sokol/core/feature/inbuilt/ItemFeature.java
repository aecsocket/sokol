 ...
 */
public abstract class ItemFeature extends AbstractFeature {
    /** The system ID. */
    ...
    public ItemFeature(Stat<? extends ItemStack.Factory> statItem) {
        super(0);
    ...
    public abstract class Instance extends AbstractFeature.Instance {
        ...
        @Override public abstract ItemFeature base();
