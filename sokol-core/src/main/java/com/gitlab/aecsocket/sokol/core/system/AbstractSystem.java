...
public abstract class AbstractSystem<N extends ScopedTreeNode<N, ?, ?, ?, ?>> implements System<N> {
    public static abstract class Instance<N extends ScopedTreeNode<N, ?, ?, ?, ?>> implements System.Instance<N> {
