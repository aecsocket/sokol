...
public final class PaperNodeHolderFeature extends NodeHolderFeature<PaperTreeNode> implements PaperFeature {
    public static final Key<Instance> KEY = new Key<>(ID, Instance.class);
    public static final LoadProvider LOAD_PROVIDER = LoadProvider.empty(ID);

    public final class Instance extends NodeHolderFeature<PaperTreeNode>.Instance implements PaperFeature.Instance {
        ...
        @Override public PaperNodeHolderFeature base() { return PaperNodeHolderFeature.this; }
    ...
    public PaperNodeHolderFeature(SokolPlugin platform, int listenerPriority, int capacity, boolean sizeAsDurability, @Nullable Rule rule) {
    ...
    public static ConfigType type(SokolPlugin platform) {
        return cfg -> new PaperNodeHolderFeature(platform,
