...
import com.gitlab.aecsocket.sokol.core.util.AbstractTreeNode;
 ...
 */
public final class PaperTreeNode extends AbstractTreeNode<PaperTreeNode, PaperComponent, PaperSlot, PaperFeature, PaperFeature.Instance> {
    /**
    ...
    public static final class Serializer implements TypeSerializer<PaperTreeNode> {
        ...
        public void serialize(Type type, @Nullable PaperTreeNode obj, ConfigurationNode node) throws SerializationException {
            if (obj == null) node.set(null);
                ...
                for (var entry : obj.systems.entrySet())
                    systems.node(entry.getKey()).set(PaperFeature.Instance.class, entry.getValue());
        ...
        private PaperTreeNode deserialize0(Type type, ConfigurationNode node) throws SerializationException {
            ...
            if (node.isMap()) {
                ...
                for (var entry : node.node("systems").get(new TypeToken<Map<String, PaperFeature.Instance>>() {}, Collections.emptyMap()).entrySet()) {
