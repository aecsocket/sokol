...
import com.gitlab.aecsocket.sokol.core.feature.inbuilt.NodeHolderFeature;
...
import com.gitlab.aecsocket.sokol.core.feature.util.InputMapper;
import com.gitlab.aecsocket.sokol.core.feature.util.SystemPath;
...
public class SokolPlugin extends BasePlugin<SokolPlugin> implements SokolPlatform {
    ...
    private final Registry<PaperFeature.KeyedType> systemTypes = new Registry<>();
    ...
    private final SchedulerFeature.GlobalScheduler<PaperEvent.Hold> systemScheduler = SchedulerFeature.GlobalScheduler.create();
    ...
    private final PaperFeature.Serializer systemSerializer = new PaperFeature.Serializer(this);
    ...
    public void onEnable() {
        ...
        registerSystemType(ItemFeature.ID, PaperItemFeature.type(this), () -> PaperItemFeature.LOAD_PROVIDER);
        registerSystemType(SlotInfoFeature.ID, PaperSlotInfoFeature.type(this), () -> PaperSlotInfoFeature.LOAD_PROVIDER);
        registerSystemType(SchedulerFeature.ID, PaperSchedulerFeature.type(this), () -> PaperSchedulerFeature.LOAD_PROVIDER);
        registerSystemType(NodeHolderFeature.ID, PaperNodeHolderFeature.type(this), () -> PaperNodeHolderFeature.LOAD_PROVIDER);
        registerSystemType(SlotsFeature.ID, SlotsFeature.type(this), () -> SlotsFeature.LOAD_PROVIDER);
        registerSystemType(PropertiesFeature.ID, PropertiesFeature.type(this), () -> PropertiesFeature.LOAD_PROVIDER);
    }
    ...
    public Registry<PaperFeature.KeyedType> systemTypes() { return systemTypes; }
    ...
    public SchedulerFeature.GlobalScheduler<PaperEvent.Hold> systemScheduler() { return systemScheduler; }
    ...
    public PaperFeature.Serializer systemSerializer() { return systemSerializer; }
     ...
     */
    public SokolPlugin registerSystemType(String id, PaperFeature.ConfigType configType, PaperFeature.LoadProviderType loadProviderType) {
        ...
        systemTypes.put(id, new PaperFeature.KeyedType() {
            @Override
            public String id() { return id; }

            @Override
            public PaperFeature createSystem(ConfigurationNode cfg) throws SerializationException {
    ...
    protected void configOptionsDefaults(TypeSerializerCollection.Builder serializers, ObjectMapper.Factory.Builder mapperFactory) {
        ...
        serializers
                ...
                .register(PaperFeature.Instance.class, systemSerializer)
