...
public class IncompatibilityException extends Exception implements Renderable {
    private final Rule rule;
    private final String lcKey;
    private final Object[] lcArgs;

    public IncompatibilityException(Rule rule, String lcKey, Object... lcArgs) {
        this.rule = rule;
        this.lcKey = lcKey;
        this.lcArgs = lcArgs;
    }

    public IncompatibilityException(Rule rule, Throwable cause, String lcKey, Object... lcArgs) {
        super(cause);
        this.rule = rule;
        this.lcKey = lcKey;
        this.lcArgs = lcArgs;
