...
public interface Rule extends Renderable {
    ...
    <N extends Node.Scoped<N, ?, ?, ?, ?>> void applies(N node, @Nullable N parent) throws RuleException;
    ...
    final class Constant implements Rule {
        ...
        @Override
        public <N extends Node.Scoped<N, ?, ?, ?, ?>> void applies(N node, @Nullable N parent) throws RuleException {
            if (!value)
